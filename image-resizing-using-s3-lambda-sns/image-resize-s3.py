...
bucket_1 = 'image-non-resize' # your-source-bucket
bucket_2 = 'image-resize-lambd' # your-destination-bucket
sns_topic_arn = 'arn:aws:sns:us-east-1:xxxxxxxxxxxx:image-resize-topic' # your-sns-topic
